...
'  // Network-first: the Worker deploys atomically, so the network always has',
'  // the newest build. The cache only exists as an offline/flaky-connection',
'  // fallback -- never as a reason to show someone yesterday\'s UI.',
'  event.respondWith(',
